...
import com.ericpeng.sprite.Bomb;
import com.ericpeng.sprite.Bullet;
import com.ericpeng.sprite.Enemy;
import com.ericpeng.sprite.Gift;
import com.ericpeng.sprite.Plane;
import com.ericpeng.util.BulletPool;
import com.ericpeng.util.Config;
import com.ericpeng.util.CreateFactory;
...
public class GameSurfaceView extends SurfaceView implements Runnable,SurfaceHolder.Callback {
	...
	public void checkCollision() {
		...
		Enemy n = null;
		Gift g = null;
		for(int i = 0; i < pool.bulletList.size(); i++)	{ //player�ӵ���enemy����ײ���
		...
		for(int i = 0; i < enemyArray.size(); i++){  //player��enemy����ײ���
			n = enemyArray.get(i);
		...
		for(int i = 0; i < enemy_pool.bulletList.size(); i++)	{ //player��enemy���ӵ���ײ���
		...
		for(int i = 0; i < giftArray.size(); i++)	{ //player��enemy���ӵ���ײ���
			g = giftArray.get(i);
